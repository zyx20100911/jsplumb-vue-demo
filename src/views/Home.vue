...
<!--        @changeLineState="changeLineState"-->
        <flowNode v-for="item in data.nodeList" :id="item.id" :key="item.id" :node="item" @setNodeName="setNodeName" @deleteNode = "deleteNode"
        @add="add"
        ></flowNode>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      jsPlumb: null,
      currentItem: {"type":"start","typeName":"节点","nodeName":"节点","id":"","top":"160px","left":"100px"},
